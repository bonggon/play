package com.bgsoft.samples.mvc.mapping;
...
public class MappingController {
	...
	@RequestMapping(value="/mapping/method", method=RequestMethod.GET, headers="FooHeader=foo")
	public @ResponseBody String byMethod() {
		return "Mapped by path + method";
	}
	
	@RequestMapping(value="/mapping/method", method=RequestMethod.GET, headers="!FooHeader")
	public @ResponseBody String byMethod2() {
		return "Mapped by path + method2";
	}
